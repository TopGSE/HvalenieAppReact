...
function SharedPlaylistModal({ 
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content shared-playlist-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <div className="playlist-info-section">
            <h3 className="playlist-name">{playlistData?.name || 'Untitled Playlist'}</h3>
            ...
            <div className="shared-by">
              Shared by: <strong>{notification.fromUserName || 'Another user'}</strong>
            </div>
          ...
          <div className="songs-section">
            ...
            {playlistData?.songs?.length > 0 ? (
              <ul className="shared-songs-list">
                {songsList}
              </ul>
            ) : (
